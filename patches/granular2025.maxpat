...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 366.0, 14.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 214.0, 110.0, 150.0, 22.0 ]
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 62.0, 11.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 62.0, 48.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 214.0, 14.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.0, 142.0, 35.0, 22.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 214.0, 62.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 214.0, 38.0, 150.0, 22.0 ],
					"text_width" : 101.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 366.0, 139.0, 39.0, 20.0 ],
					"text" : "ms"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 214.0, 86.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 279.0, 48.25, 48.25 ]
				}
...
,
									"text" : "param density @value 50 @min 1 @max 100",
									"varname" : "density"
								}
...
,
									"text" : "param feedCoe @value 0.5 @min 0.01 @max 0.9",
									"varname" : "feedCoe"
								}
...
,
									"text" : "param delTime @value 100 @min 2. @max 2500",
									"varname" : "delTime"
								}
...
,
									"text" : "param Mix @value 50. @min 0. @max 100.",
									"varname" : "Mix"
								}
...
,
									"text" : "param reverse @value 0 @min 0 @max 1",
									"varname" : "reverse"
								}
...
,
									"text" : "param movDur @value 500. @min 5. @max 1000.",
									"varname" : "movDur"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 72.0, 81.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 81.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 72.0, 13.0, 35.0, 23.0 ],
									"rnbo_classname" : "in~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
,
									...
									"patching_rect" : [ 10.0, 46.0, 81.0, 23.0 ],
									"rnbo_classname" : "gen~",
									"rnbo_extra_attributes" : 									{
										"exposeparams" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 10.0, 13.0, 35.0, 23.0 ],
									"rnbo_classname" : "in~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
,
					"saved_object_attributes" : 					{
						"optimization" : "O1",
						"parameter_enable" : 1,
						"uuid" : "102c0101-37d5-11f0-8101-acde48001122"
					}
,
					"snapshot" : 					{
...
,
							"__presetid" : "102c0101-37d5-11f0-8101-acde48001122"
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "untitled",
									"origin" : "102c0101-37d5-11f0-8101-acde48001122",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "untitled",
										"filename" : "untitled_20250523.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "0afea4e5371c0213010a3d2ca532261a"
									}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 7.0, 11.0, 52.0, 52.0 ]
				}
...
, 			{
				"name" : "untitled_20250523.maxsnap",
